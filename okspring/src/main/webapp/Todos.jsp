<!DOCTYPE html>
<!-- saved from url=(0053)http://localhost:8080/simple/backbone/examples/todos/ -->
...
<div id="__KO_DIC_LAYER__" style="padding: 0px; position: fixed; z-index: 999999999; overflow: hidden; border: 2px solid rgb(51, 51, 119); display: none;"><iframe frameborder="0" scrolling="yes" style="width: 100%; height: 100%; background-color: rgb(255, 255, 255);"></iframe></div></body></html>